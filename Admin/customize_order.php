...
<?php require_once('customize_order_delete.php');?>
<!doctype html>
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="customize_order.css">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                <tr>
                  ...
                  <td><img class="pic-1" src="../upload_c/server/uploads/<?php echo $filenames[0];?>" width="40px" height="63.56px"></td>
                  <td><?php echo $row['n_date']; ?></td>
                  <td><?php echo $row['date']; ?></td>
                  <td><a href="c_order_d.php?mcategory=<?php echo $row['cu_id']; ?>"><i class="fa fa-eye"></i></a>
                  <input type="hidden" name="cuid" value="<?php echo $row['cu_id']; ?>">
                      <button class="btn-delete" name="delete" onclick="return confirm('Are you sure to Remove your Product ?')"><i class="fas fa-trash"></i></button>
                  </td>
                </tr>
                <?php }?>
              </tbody>
