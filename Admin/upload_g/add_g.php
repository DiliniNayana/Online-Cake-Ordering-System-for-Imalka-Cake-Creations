...
<br>
<br>
<a href="../addgallery.php" class="gallery_back">Back</a>

    <h2 class="subtopic">Add new image</h2>
            ...
            <div class="container1">
                <div class="form_content">
                    <form method="post" action="server/form_process.php">
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1" class="label1">Enter Description</label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description"></textarea>
                        </div>

                        <button type="submit1" class="btn btn-primary1" name="submit1">Submit</button>
