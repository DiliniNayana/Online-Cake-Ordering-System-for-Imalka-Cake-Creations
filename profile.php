  ...
  <body>
    ...
    <div class="login-popup-wrap new_login_popup">
      <div class="login-popup-heading text-left">
          <h3 class="topic"> My Profile Details</h3> 
    ...
    <div class="card border-0 ">
      ...
      <h6><b>Full name : </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php  echo $_SESSION['fname']." ".$_SESSION['lname']; ?></h6>
      <br>
      <h6><b>Email Address : </b>&nbsp;&nbsp;&nbsp;<?php echo $_SESSION['c_email'];?></h6>
            ...
            <a class="rbtn" href="change_pass.php">
            Change Password</a>
            <?php } ?>
      </form>
      </div>
